...
namespace MjmlDotNet.PerformanceTests
{
    public class MjmlDotNetBenchmark
    {
        private readonly IMjmlParser _mjmlParser = new MjmlParser();
        private readonly string _mjmlDocument;
        ...
        public MjmlDotNetBenchmark()
        {
                      ...
                      <mj-section background-color=""#ffffff"" padding-left=""15px"" padding-right=""15px"">
                        ...
                        <mj-column width=""50%"">
                          ...
                          <mj-text color=""#637381"" font-size=""14px"" padding-top=""0"">
                            ...
                            <br/> Tuesday, December 21st: 8:00AM - 5:00PM
                          </mj-text>
                        </mj-column>
                      </mj-section>
                      <mj-section background-color=""#ffffff"" padding-left=""15px"" padding-right=""15px"">
            ...
            ";
            _parserOptions = new MjmlParserOptions()
            {
                Minify = true
            };
        }
        ...
        [Benchmark]
        public string TryParseDocument()
        {
            if (!_mjmlParser.TryParseDocument(_mjmlDocument, _parserOptions, out var html))
            {
                return string.Empty;
            }
        ...
        {
            return _mjmlParser.ParseDocument(_mjmlDocument, _parserOptions);
        }

        [Benchmark]
        public async Task<string> ParseDocumentAsync()
        {
            return await _mjmlParser.ParseDocumentAsync(_mjmlDocument, _parserOptions);
        }
    }
